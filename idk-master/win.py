...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.groupBox_18.setStyleSheet("#groupBox_18{border-image: url(:/img/icon/hhu_background.jpg);\n"
...
"border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("image: url(:/img/icon/hhu_logo.png);")
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icon/最大化.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-image: url(:/img/icon/下拉.png);\n"
"}\n"
"")
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        self.progressBar.setStyleSheet("QProgressBar{ color: rgb(255, 255, 255); font:12pt; border-radius:2px; text-align:center; border:none; background-color: rgba(100, 100, 100,100);} \n"
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.label_4.setText(_translate("mainWindow", "口罩检测界面"))
        ...
        self.checkBox.setText(_translate("mainWindow", "是否开启"))
